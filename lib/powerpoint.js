...
class Powerpoint extends EventEmitter2 {
  ...
  _convertWithGhostScript (outputDir, pdfFiles, options, callback) {
    ...
    // -dNOTRANSPARENCY - (No Effect) Turns off PDF 1.4 transparency, resulting in faster (but possibly incorrect) rendering of pages containing PDF 1.4 transparency and blending.
